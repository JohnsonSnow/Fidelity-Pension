namespace FidelityPension.Migrations
{
    ...
    public partial class D89 : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.Employees", "BENEFICIARY_Building_No");
            DropColumn("dbo.Employees", "NOK_Building_No");
            DropColumn("dbo.Employees", "Correspondence_Building_No");
            DropColumn("dbo.Employees", "Residential_Building_No");
        }
    }
}
