...
namespace FidelityPension.App_Start
{
    public class CustomRequireHttpsFilter : RequireHttpsAttribute
    {
        protected override void HandleNonHttpsRequest(AuthorizationContext filterContext)
        {
            ...
            string url = "https://" + filterContext.HttpContext.Request.Url.Host + ":8443" + filterContext.HttpContext.Request.RawUrl;
            ...
            if (string.Equals(filterContext.HttpContext.Request.Url.Host, "localhost", StringComparison.OrdinalIgnoreCase))
            {
                ...
                url = "https://" + filterContext.HttpContext.Request.Url.Host + ":44393" + filterContext.HttpContext.Request.RawUrl;
            }
